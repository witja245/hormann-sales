    ...
    <div class="form-image margin-72">
        <div class="form-image__left">
            <div class="form__row">
                ...
                <div class="form__col">
                    <div class="form__input">
                        <div class="form__label">Глубина задвигания – C</div>
                        <div class="form__field">
                            <input type="text"
                                   name="form_<?= $arResult["QUESTIONS"]["FIELD_C"]["STRUCTURE"][0]["FIELD_TYPE"] . "_" . $arResult["QUESTIONS"]["FIELD_C"]["STRUCTURE"][0]["ID"] ?>">
                            <div class="form__field__sm">см</div>
                        </div>
                    </div>
                </div>
                <div class="form__col">
                    <div class="form__input">
                        <div class="form__label">Перемычка – D</div>
                        <div class="form__field">
                            <input type="text"
                                   name="form_<?= $arResult["QUESTIONS"]["FIELD_D"]["STRUCTURE"][0]["FIELD_TYPE"] . "_" . $arResult["QUESTIONS"]["FIELD_D"]["STRUCTURE"][0]["ID"] ?>">
                            <div class="form__field__sm">см</div>
                        </div>
                    </div>
                </div>
                <div class="form__col">
                    <div class="form__input">
                        <div class="form__label">Упор слева – E</div>
                        <div class="form__field">
                            <input type="text"
                                   name="form_<?= $arResult["QUESTIONS"]["FIELD_E"]["STRUCTURE"][0]["FIELD_TYPE"] . "_" . $arResult["QUESTIONS"]["FIELD_E"]["STRUCTURE"][0]["ID"] ?>">
                            <div class="form__field__sm">см</div>
                        </div>
                    </div>
                </div>
                <div class="form__col">
                    <div class="form__input">
                        <div class="form__label">Упор справа – F</div>
                        <div class="form__field">
                            <input type="text"
                                   name="form_<?= $arResult["QUESTIONS"]["FIELD_F"]["STRUCTURE"][0]["FIELD_TYPE"] . "_" . $arResult["QUESTIONS"]["FIELD_F"]["STRUCTURE"][0]["ID"] ?>">
                            <div class="form__field__sm">см</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form__input">
                <div class="form__label">Управление воротами</div>
                <div class="select" data-app="select">
                    <select name="form_<?= $arResult["QUESTIONS"]["MANAGE"]["STRUCTURE"][0]["FIELD_TYPE"] . "_" . $arResult["QUESTIONS"]["MANAGE"]["STRUCTURE"][0]["ID"] ?>">
                        <option value="SupraMatic">SupraMatic</option>
                        <option value="ProMatic">ProMatic</option>
                        <option value="ProMatic Akku">ProMatic Akku</option>
                        <option value="Ручное управление">Ручное управление</option>
                        <option value="Не знаю, посоветуйте">Не знаю, посоветуйте</option>
                    </select>
                    <a class="help" href="#help-drive" data-fancybox>?</a>
                </div>
            </div>
        </div>
