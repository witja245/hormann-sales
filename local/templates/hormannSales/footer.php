<? if (CSite::InDir('/products/')): ?>
    <div class="footer-bnft" xmlns="http://www.w3.org/1999/html">
        <div class="container">
            <div class="bnft">
                <div class="bnft__item">
                    <div class="bnft__item-icon"><img src="/img/bnft-icon-1.svg"></div>
                    <div class="bnft__item-title">12 филиалов и более 160 официальных дистрибьюторов в РФ — оставьте
                        заявку в ближайшем к вам центре
                    </div>
                    <div class="bnft__item-desc">Бесплатный выезд на замер осуществляется в течение 0-5 дней. Доставка,
                        разгрузка и установка под ключ — 1 день. Готовые комплекты ворот стандартных размеров всегда в
                        наличии на складе, возможность производства под заказ.
                    </div>
                </div>
                <div class="bnft__item">
                    ...
                    <div class="bnft__item-desc">С 1935 года разрабатываем решения для устройства въезда/выезда в гараж
                        частного дома, коммерческого объекта, производственного помещения. Предложим несколько вариантов
                        на выбор и оптимальную комплектацию под параметры вашего проема и бюджет.
                    </div>
                </div>
                <div class="bnft__item">
                    ...
                    <div class="bnft__item-desc">Ворота рассчитаны на 25 000 циклов. Срок службы продукции Hormann —
                        более 25 лет. Подтвержден длительными испытаниями на прочность и долговечность в реальных
                        условиях, а также личным опытом наших клиентов. Оригинальные запчасти в наличии.
                    </div>
                </div>
                <div class="bnft__item">
                    <div class="bnft__item-icon"><img src="/img/bnft-icon-4.svg"></div>
                    <div class="bnft__item-title">Выбирайте инновационные технологии и экологически безопасные
                        материалы
                    </div>
                    <div class="bnft__item-desc">Ворота, двери, автоматика, комплектующие, перегрузочная техника и
                        системы контроля доступа изготавливаются с учетом строгих экологических требований, обеспечивают
                        нулевой уровень выбросов CO2. Стройматериалы и оборудование, используемые Hormann, включены в
                        Green Book.
                    </div>
                </div>
            </div>
        ...
        <div class="is-footer__container">
            ...
            <div class="is-footer__left">
                ...
                <ul class="is-footer__nav">
                    ...
                    <li class="is-footer__nav-item">
                        <a href="/products/avtomatika-dlya-vorot/" class="is-link is-footer__nav-text">Электроприводы
                            для дистанционного открывания ворот</a>
                    </li>
                    <li class="is-footer__nav-item">
                        <a href="/products/promyshlennye-vorota/" class="is-link is-footer__nav-text">Промышленные
                            ворота</a>
                    </li>
                    <li class="is-footer__nav-item">
                        <a href="/products/peregruzochnoe-oborudovanie/" class="is-link is-footer__nav-text">Перегрузочное
                            оборудование</a>
                    </li>
                    <li class="is-footer__nav-item">
                        <a href="/products/sistemy-kontrolya-vezda/" class="is-link is-footer__nav-text">Системы
                            контроля проезда<br>транспорта на территорию</a>
                    </li>
                </ul>
                <div class="ya-rating">
                    <div class="ya-rating__title">Честные отзывы</div>
                    <iframe src="https://yandex.ru/sprav/widget/rating-badge/48495365425?type=rating" width="150"
            ...
            <div class="is-footer__center">
                <ul class="is-footer__nav">
                    ...
                    <li class="is-footer__nav-item">
                        <a href="/business/service/" class="is-link is-footer__nav-text">Услуги по ремонту,
                            диагностике<br>и постгарантийному<br>обслуживанию</a>
                    </li>
                    <li class="is-footer__nav-item">
                ...
                <ul class="is-footer__nav">
                    ...
                    <li class="is-footer__nav-item">
                        <a href="/media/documents/" class="is-link is-footer__nav-text">Документация по монтажу<br>и
                            эксплуатации</a>
                    </li>
                    <li class="is-footer__nav-item">
                        <a href="/media/" class="is-link is-footer__nav-text">Каталоги товаров с<br>характеристиками и
                            фото</a>
                    </li>
                    <li class="is-footer__nav-item">
            ...
            <div class="is-footer__right">
                <div class="is-footer__r-contacts">
                    <a class="phone is-link"
                       href="tel:<?= \COption::GetOptionString("askaron.settings", "UF_PHONE")[0] ?>"><?= \COption::GetOptionString("askaron.settings", "UF_PHONE")[1] ?></a>
                    ...
                    <div class="is-footer__social">
                        <ul class="social-list">
                            <li class="social-list__item"><a href="https://vk.com/hormann_russia" target="_blank"><img
                                            src="/img/vk.png"></a></li>
                            <li class="social-list__item"><a href="https://dzen.ru/id/61e688499f1f78798c81dd64"
                                                             target="_blank"><img src="/img/dzen.png"></a></li>
                            <li class="social-list__item"><a href="https://rutube.ru/channel/43487913/" target="_blank"><img
                                            src="/img/rutube.png"></a></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="is-footer__b-cont">
                ...
                <div class="is-footer__b-right">
                    <a class="is-link item" target="_blank" href="https://proton-marketing.ru/">Продвижение сайта
                        proton-marketing.ru</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?= DEFAULT_TEMPLATE_MAIN_PATH ?>/js/slider.js"></script>
<script src="<?= DEFAULT_TEMPLATE_MAIN_PATH ?>/js/jquery.fancybox.min.js"></script>
<script src="<?= DEFAULT_TEMPLATE_MAIN_PATH ?>/js/jquery.maskedinput.js"></script>
<script src="<?= DEFAULT_TEMPLATE_MAIN_PATH ?>/js/main.js"></script>
<script>
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KVCKJJS"
...
<script>
    ...
    document.addEventListener('click', function (e) {
        if (e.target.closest('form button[type="submit"]')) {
            SendCalltouch(e.target.closest('form'))
        }
    });
    ...
    function GetElem(form, value) {
        ...
        elements.forEach(el => {
            ...
            if (regex.test(text)) {
                console.log(el.closest('div.form__input'));
                result = el.closest('div.form__input').querySelector('input').value;
                return false;
            }
        });
        return result;
