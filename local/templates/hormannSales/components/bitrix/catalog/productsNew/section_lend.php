...
//                        "DETAIL_URL" => $arResult["FOLDER"] . $arResult["URL_TEMPLATES"]["element"],
        ...
        <div class="container">
            ...
            <?if($arCurSection['UF_UNDER_CATALOG_IMAGE']):?>
            <div class="topic topic_sort margin-120">
                <div class="topic__item wow" data-wow-offset="200" style="background-image:url(<?=CFile::GetPath($arCurSection['UF_UNDER_CATALOG_IMAGE'])?>)">
                    <div class="title-text"><?=$arCurSection['UF_UNDER_CATALOG']?></div>
                </div>
            </div>
            <?endif;?>
            <?
