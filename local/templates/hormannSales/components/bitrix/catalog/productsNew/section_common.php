    ...
    <div class="container">
        <div class="main_wrapper">
            <div class="main_info">
                ...
                <h1 class="main_title"><?= $section['NAME'] ?></h1>
            </div>
        </div>
    </div>
</section>
...
//                        "DETAIL_URL" => $arResult["FOLDER"] . $arResult["URL_TEMPLATES"]["element"],
        ...
        $arFilter = array('IBLOCK_ID' => 33, 'CODE' => $code);
        $rsSections = CIBlockSection::GetList([], $arFilter, false, ['UF_SHORT_TEXT', 'UF_TITLE_UNDER_BANNER']);
        $section = $rsSections->Fetch();
        ?>
        <div class="subtext wow" data-wow-offset="200"
             style="margin-bottom: 20px"><?= $section['UF_SHORT_TEXT'] ?></div>
        <? if ($section['UF_TITLE_UNDER_BANNER']): ?>
            <div class="title-text wow" data-wow-offset="200"><?= $section['UF_TITLE_UNDER_BANNER'] ?></div>
        <? endif; ?>
...
//                        "DETAIL_URL" => $arResult["FOLDER"] . $arResult["URL_TEMPLATES"]["element"],
        ...
        <?php global $filterShare;
        $filterShare = ['PROPERTY_SECTION' => $arResult['VARIABLES']['SECTION_ID']];
        $APPLICATION->IncludeComponent(
            "bitrix:news.list",
            "share.product",
            array(
