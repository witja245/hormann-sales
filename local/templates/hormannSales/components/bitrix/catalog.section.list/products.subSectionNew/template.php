...
<!--                <div class="container">-->
<!--                    <h2 class="title">--><?php //= $subSectionDesc['NAME'] ?><!--</h2>-->
<!--                    <div class="series_content active">-->
<!--                        <div class="series_content-wrapper">-->
<!--                            <div class="series_info">-->
<!--                                --><?php //= $subSectionDesc['DESCRIPTION'] ?>
<!--                                <a href="--><?php //= $subSectionDesc['SECTION_PAGE_URL'] ?><!--"-->
<!--                                   class="series_btn btn">Подробнее</a>-->
<!--                            </div>-->
<!--                            <div class="series_img"><img src="--><?php //= $subSectionDesc['PICTURE']['SRC'] ?><!--"-->
<!--                                                         alt="--><?php //= $subSectionDesc['NAME'] ?><!--"></div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </section>-->
