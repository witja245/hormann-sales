...
// get Prompt for property
$entity = \Itech\Helper::getHlEntityByCode('Prompt');
$prompts = [];
...
while ($el = $elementsDb->fetch()) {
    $el['UF_IMAGE'] = $el['UF_IMAGE'] ? \CFile::getPath($el['UF_IMAGE']) : false;
    $prompts[$el['UF_CODE']] = $el;
}

$arResult['PROMPTS'] = $prompts;
